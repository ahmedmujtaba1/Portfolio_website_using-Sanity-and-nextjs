        ...
        <div className=" bg-white ">
            <nav className="shadow-xl 2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div className="flex justify-between ">
                    ...
                    <svg className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer hover:text-blue-500" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className=" flex space-x-3 items-center">
                        ...
                        <h1 className=" font-normal text-2xl leading-6 text-gray-800">Ahmed Mujtaba</h1>
                    </div>
                    <div className="hidden sm:flex flex-row space-x-4">
                        ...
                        <button className="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-white bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-600 hover:bg-indigo-600 duration-150 justify-center items-center">Contact Me</button>
                    </div>
                    {/* Burger Icon */}
