...
const ContactTextArea: React.FC<ContactTextAreaProps> = ({ row, placeholder, name, defaultValue, onChange }) => {
  return (
    <>
      <div className="mb-6">
        <textarea
...
const ContactInputBox: React.FC<ContactInputBoxProps> = ({ type, placeholder, name, onChange }) => {
  return (
    <>
      <div className="mb-6">
        <input
...
interface FormData {
  ...
  email: string | boolean | any;
  phone: string | boolean | any;
  details: string | boolean | any;
}
  ...
  return (
    <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form onSubmit={handleSubmit}>
                  ...
                  />
                  {formErrors.name && <span className="text-red-500">Please fill this field</span>}
                  <ContactInputBox
                    type="text"
                    name="email"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-black hover:bg-indigo-700 hover:text-white transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
